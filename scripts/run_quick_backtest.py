...
=======================
Run a quick backtest for funding arbitrage strategy with profitability proof
"""
...
async def run_quick_backtest():
    """Run a quick backtest with shorter time period"""
    
    print("🎯 QUICK BACKTEST FOR FUNDING ARBITRAGE STRATEGY")
    print("=" * 60)
    print("Running quick backtest with profitability proof")
    print("=" * 60)
    
    # Initialize logger
    logger = Logger()
    
    # Configure backtest (shorter period for quick testing)
    ...
    print("📊 Quick Backtest Configuration:")
    ...
    print(f"\n⏱️ Quick backtest completed in {execution_time:.2f} seconds")
...
async def main():
    """Main function"""
    try:
        results = await run_quick_backtest()
        return results
    except Exception as e:
        print(f"❌ Quick backtest failed with error: {e}")
        import traceback
        traceback.print_exc()
        return None
