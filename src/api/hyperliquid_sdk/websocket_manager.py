...
from hyperliquid_sdk.utils.types import Any, Callable, Dict, List, NamedTuple, Optional, Subscription, Tuple, WsMsg
...
class WebsocketManager(threading.Thread):
    ...
    def subscribe(
        ...
        if not self.ws_ready:
            ...
            # NOTE: Currently, userEvent and orderUpdates messages do not include the user, so multiplexing is not supported yet.
            # See COMPREHENSIVE_CLEANUP_REPORT.md for roadmap.
